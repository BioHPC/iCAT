...
```{r include = FALSE}
knitr::include_graphics("reference/figures/icat.png")
```

![Alt text](reference/figures/icat.png?raw=true "Training")
...
![Alt text](reference/figures/lib-icat.png?raw=true "Library")
...
![Alt text](reference/figures/pred-icat.png?raw=true "Prediction")
